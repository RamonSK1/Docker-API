...
Revision ID: d96233c75598
Revises: 
Create Date: 2025-04-23 23:26:11.187893
...
def upgrade():
    ...
    op.create_table('ingrediente_quantidade',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('ingrediente_quantidade')
